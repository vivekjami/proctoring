...
def process():
    global GLOBAL_CHEAT, PERCENTAGE_CHEAT, CHEAT_THRESH , CHEAT_COUNTER #head_pose.X_AXIS_CHEAT, head_pose.Y_AXIS_CHEAT, audio.AUDIO_CHEAT
    ...
    if PERCENTAGE_CHEAT > CHEAT_THRESH:
        GLOBAL_CHEAT = 1
        CHEAT_COUNTER += 1
        print("CHEATING DETECTED :", CHEAT_COUNTER)
    else:
        GLOBAL_CHEAT = 0
